...
def create_title_slide():
    ...
    # 添加标题
    title = slide.shapes.add_textbox(Inches(2), Inches(3), Inches(12), Inches(2))
    tf = title.text_frame
    tf.text = "旅游票务系统"
    p = tf.paragraphs[0]
    p.font.size = Pt(48)
    ...
    # 添加副标题
    subtitle = slide.shapes.add_textbox(Inches(2), Inches(5), Inches(12), Inches(2))
...
def create_content_slide(title_text, content_text):
    ...
    # 添加标题
    title = slide.shapes.add_textbox(Inches(1), Inches(1), Inches(14), Inches(1))
    tf = title.text_frame
    tf.text = title_text
    p = tf.paragraphs[0]
    p.font.size = Pt(32)
    ...
    # 添加内容
    content = slide.shapes.add_textbox(Inches(1.5), Inches(2), Inches(13.5), Inches(5))
...
def create_thanks_slide():
    ...
    # 添加副标题
    subtitle = slide.shapes.add_textbox(Inches(2), Inches(5), Inches(12), Inches(1))
    tf = subtitle.text_frame
    tf.text = "欢迎提问"
    p = tf.paragraphs[0]
    p.font.size = Pt(24)
